...
DEFAULT_INPUT = "/home/sladefox/.local/lib/python3.12/site-packages/ochre/defaults/Input Files"
ochre_dir = Path(ochre.__file__).resolve().parent
print("OCHRE installed at:", ochre_dir)
print(DEFAULT_INPUT)
DEFAULT_WEATHER = "/home/sladefox/.local/lib/python3.12/site-packages/ochre/defaults/Weather/USA_OR_Portland.Intl.AP.726980_TMY3.epw"

# Safe working folder (writable)
WORKING_DIR = "/home/sladefox/ochre_working"
